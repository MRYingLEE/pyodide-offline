/*! For license information please see 424.05b5cf9e6b39acab6ea7.js.LICENSE.txt */
"use strict";
    ...
    176: (e, t, n) => {
      n.r(t),
        n.d(t, {
          ...
          ipykernelWheelUrl: () => i,
          pipliteWheelUrl: () => l,
          pyodide_kernelWheelUrl: () => p,
          widgetsnbextensionWheelUrl: () => d,
          widgetsnbextensionWheelUrl1: () => h,
        });
      const r = n.p + "pypi/all.json";
      var a = n.t(r);
      const s = n.p + "pypi/ipykernel-6.9.2-py3-none-any.whl.zip";
      var i = n.t(s);
      const o = n.p + "pypi/piplite-0.2.0-py3-none-any.whl.zip";
      var l = n.t(o);
      const c = n.p + "pypi/pyodide_kernel-0.2.0-py3-none-any.whl.zip";
      var p = n.t(c);
      const u = n.p + "pypi/widgetsnbextension-3.6.6-py3-none-any.whl.zip";
      var d = n.t(u);
      const m = n.p + "pypi/widgetsnbextension-4.0.9-py3-none-any.whl.zip";
      var h = n.t(m),
        y = n(930),
        g = n(614),
        b = n(430);
      ...
      function R(e, t = globalThis, n = ["*"]) {
        t.addEventListener("message", function r(a) {
          ...
          const {
            ...
            l = (a.data.argumentList || []).map(T);
          let c;
          try {
            const t = o.slice(0, -1).reduce((e, t) => e[t], e),
              n = o.reduce((e, t) => e[t], e);
            switch (i) {
              case "GET":
                c = n;
                break;
              case "SET":
                (t[o.slice(-1)[0]] = T(a.data.value)), (c = !0);
                break;
              case "APPLY":
                c = n.apply(t, l);
                break;
          ...
          Promise.resolve(c)
            ...
            .then((n) => {
              const [a, o] = K(n);
              t.postMessage(Object.assign(Object.assign({}, a), { id: s }), o),
                "RELEASE" === i &&
                  (t.removeEventListener("message", r),
                  P(t),
                  v in e && "function" == typeof e[v] && e[v]());
            })
            .catch((e) => {
              const [n, r] = K({
              ...
              t.postMessage(Object.assign(Object.assign({}, n), { id: s }), r);
            });
        }),
          t.start && t.start();
      }
      ...
      function W(e, t = [], n = function () {}) {
        ...
        const a = new Proxy(n, {
          ...
          apply(n, a, s) {
            ...
            if (i === w) return j(e, { type: "ENDPOINT" }).then(T);
      ...
      function K(e) {
        ...
        return [{ type: "RAW", value: e }, L.get(e) || []];
      }
      function T(e) {
        switch (e.type) {
          case "HANDLER":
      ...
      class H extends b.BaseKernel {
        constructor(e) {
          super(e),
            ...
            (this._remoteKernel = C(this._worker)),
            this.initRemote(e);
        }
        initWorker(e) {
          return new Worker(new URL(n.p + n.u(568), n.b), { type: void 0 });
        }
        async initRemote(e) {
        ...
        _processWorkerMessage(e) {
          ...
          if (e.type)
            switch (e.type) {
              ...
              case "clear_output": {
                const t =
                  null !== (s = e.bundle) && void 0 !== s ? s : { wait: !1 };
        ...
        async kernelInfoRequest() {
          return {
            ...
            help_links: [
              { text: "Python (WASM) Kernel", url: "https://pyodide.org" },
            ],
          };
        }
...
//# sourceMappingURL=424.05b5cf9e6b39acab6ea7.js.map?v=05b5cf9e6b39acab6ea7
